...
#### Приемущества:
* Быстрая работы системы: быстрая модель в купе с быстрым разделением входного текста на вопрос и ответ

* Точность: предоставленный ответ всегда взят из контекста

#### Недостатки:
* Ограничен задачами, где ответ представлен явно в контексте

* Требует определенный формат подаваемых на вход данных: вопрос должен содержать вопросительный знак
...
Run the code to download modle from HF
Run bot/main.py -->
